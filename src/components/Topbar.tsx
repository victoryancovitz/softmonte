...
const NAV_GROUPS: NavGroupDef[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/financeiro/fluxo-caixa', label: 'Fluxo de Caixa', icon: ic.report },
      { href: '/financeiro/categorias', label: 'Despesas por Categoria', icon: ic.fin },
...
export const MODULE_TABS: { groupPaths: string[]; tabs: ModuleTab[] }[] = [
  ...
  },
  {
    ...
    tabs: [
      { href: '/financeiro', label: 'Lançamentos', match: ['/financeiro', '/financeiro/novo', '/financeiro/ofx'] },
      { href: '/financeiro/fluxo-caixa', label: 'Fluxo de Caixa', match: ['/financeiro/fluxo-caixa', '/financeiro/cashflow', '/forecast'] },
      { href: '/financeiro/categorias', label: 'Categorias', match: ['/financeiro/categorias'] },
