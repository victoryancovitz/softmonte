    ...
    <>
      ...
      {filtered.length === 0 && (
        <div className="bg-white rounded-xl border border-gray-200 p-10 text-center">
          ...
          <p className="text-gray-500 text-sm font-medium">Nenhum funcionário cadastrado ainda.</p>
          {hasFilter ? (
            ...
            <Link href="/rh/admissoes/wizard" className="mt-3 inline-block px-4 py-2 bg-brand text-white rounded-xl text-sm font-bold hover:bg-brand-dark">→ Admitir primeiro funcionário</Link>
          )}
        </div>
      )}
    </>
