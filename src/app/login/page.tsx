      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500 mt-0.5">Gestão de Obras & HH</div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="voce@softmonte.com.br"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent"
              />
            </div>
            <div>
        ...
        <p className="text-xs text-center text-gray-400 mt-4">
          Conta criada automaticamente com acesso de funcionário.<br/>
          O administrador pode alterar o nível de acesso.
        </p>
      </div>
    </div>
  )
