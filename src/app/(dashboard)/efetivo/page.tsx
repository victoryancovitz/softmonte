      ...
      <div className="mb-6 flex items-start justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Registre quem trabalhou no dia. Para editar o histórico, importar folha ou fechar o mês, use a tela de
            <Link href="/ponto" className="text-brand font-semibold hover:underline ml-1">Ponto</Link>.
          </p>
        </div>
        <Link href="/ponto"
          className="px-3 py-2 border border-brand text-brand rounded-xl text-xs font-semibold hover:bg-brand/5 whitespace-nowrap">
          📅 Abrir Ponto do mês
        </Link>
      </div>
